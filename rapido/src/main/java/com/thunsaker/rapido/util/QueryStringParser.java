...
/* 
 * 
 * QueryStringParser was written by ddewaele
 * https://github.com/ddewaele/AndroidTwitterGoogleApiJavaClient
 * 
 */
...
public class QueryStringParser {
    ...
    private String getValue() {
        if (paramValue == null) {
            ...
            try {
                paramValue = URLDecoder.decode(queryString.substring(paramNameEnd+1, paramEnd), Util.ENCODER_CHARSET);
            } catch (Exception ex) {
                throw new Error(ex);
            }
        }
